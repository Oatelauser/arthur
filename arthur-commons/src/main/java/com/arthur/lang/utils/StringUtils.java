...
public abstract class StringUtils {
	...
	public static List<String> split(String str, String delimiter) {
		...
		while (true) {
			int index = str.indexOf(delimiter, fromIndex);
			if (index < 0) {
				stringList.add(str.substring(fromIndex));
				break;
			}
			stringList.add(str.substring(fromIndex, index));
	 ...
	 * @return 存在的子串个数
	 */
	public static int count(String str, final String sub) {
		if (str == null || StringUtils.isEmpty(sub)) {
			return 0;
		}
