...
public class GenericTypeResolver {
    ...
    public static Class<?> resolveFieldClass(Field field, Type srcType) {
        return typeToClass(resolveFieldType(field, srcType));
    }
    ...
    public static Class<?>[] resolveParamClasses(Method method, Type srcType) {
        Type[] types = resolveParamTypes(method, srcType);
