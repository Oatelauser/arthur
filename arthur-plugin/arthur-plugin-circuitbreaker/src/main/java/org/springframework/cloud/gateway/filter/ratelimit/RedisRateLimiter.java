...
public class RedisRateLimiter extends AbstractRateLimiter<RedisRateLimiter.Config> implements ApplicationContextAware {
    ...
    protected RedisScript<List<Long>> script;
    ...
    public Mono<Response> isAllowed(String routeId, String id) {
        ...
        try {
            ...
            List<String> scriptArgs = Arrays.asList(String.valueOf(replenishRate), String.valueOf(burstCapacity), String.valueOf(Instant.now().getEpochSecond()), String.valueOf(requestedTokens));
